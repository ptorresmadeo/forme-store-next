      ...
      {enviado ? (
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="form-group">
            ...
            <input type="text" id="nombre" name="nombre" value={form.nombre} onChange={handleChange} placeholder="Tu nombre" />
          ...
          <div className="form-group">
            ...
            <textarea id="mensaje" name="mensaje" value={form.mensaje} onChange={handleChange} placeholder="Tu mensaje..." />
